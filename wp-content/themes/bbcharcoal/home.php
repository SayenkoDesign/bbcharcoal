    ...
    <div id="primary" class="content-area">
        ...
        <main id="main" class="site-main" role="main">
            ...
            if( function_exists( 'facetwp_display' ) ) {
                ...
                printf( '<div class="filters"><span>%s</span>%s%s%s</div>', 
                'Filter By:',
            ...
            if ( have_posts() ) : ?>
               ...
               <?php
               echo '<div class="row small-up-1 medium-up-2 large-up-3 xlarge-up-4 facetwp-template" data-equalizer data-equalize-on="medium" id="posts-grid">';
